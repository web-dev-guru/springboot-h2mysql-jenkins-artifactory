...
public class CommentController {
    ...
    @PutMapping(value="/api/comments/{commentid}", consumes = "application/json", produces = "application/json")
    public ResponseEntity<Comment> findCommentById(@PathVariable String commentid,@RequestBody Comment comment){
        ...
        commentService.save(Optioncomment.get());
